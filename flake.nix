{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      glvndVendorDefaults = "/run/opengl-driver/share/glvnd/egl_vendor.d:/etc/glvnd/egl_vendor.d:/usr/share/glvnd/egl_vendor.d";
      ...
      spaNodeModulesHashes = {
        ...
        x86_64-linux = "sha256-dquPyJ+KPMd7B//SQyeMUXR2xqeuF/yNOhJEK3j3BwU=";
      ...
      ledgelineIcns =
        pkgs.runCommand "ledgeline.icns" {
      ...
      bundledHledger =
        pkgs.runCommand "hledger-bundled-${bundledHledgerVersion}" {
          src = pkgs.fetchurl {
            url =
              "https://github.com/simonmichael/hledger/releases/download/"
      ...
      linuxDist =
        pkgs.runCommand "ledgeline-${version}"
        {
          nativeBuildInputs = [
