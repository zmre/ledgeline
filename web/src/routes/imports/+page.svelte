<script lang="ts">
    // The Imports screen: a master list of `*.rules` files beside the journal,
    ...
    //
    // The page owns three pieces of state and nothing else: which file is
    ...
    // The account autocomplete is the only thing this page wants from the
    // journal feed, and `AccountInput` already copes with an empty list.
