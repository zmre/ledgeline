...
describe("UNIT ConvertNote rendering", () => {
    it.each([
        ...
        [
            {kind: "statementChosen", of: 2} as const,
            "This file holds 2 statements, one per account. Only the first was read — import the others by downloading them separately.",
        ],
